...
class _RestClient implements RestClient {
  ...
  Future<MoviesNewUpdateResponse> getMoviesNewUpdate({
    ...
    final _options = _setStreamType<MoviesNewUpdateResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<MovieDetailResponse> getMovieDetail({required String slug}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<SearchMovieResponse> searchMovies({required String name}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SearchMovieResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
